var trackingDataUtil = (function () {
    /* Import Configuration data from config file */
    var configurationData = config.configurationData;

    var isStaticExternalData = configurationData.isStaticExternalData;

    /* Extension external data */
    var externalData = configurationData.externalData;
